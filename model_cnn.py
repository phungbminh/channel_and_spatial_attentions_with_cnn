...
from tensorflow.keras.layers import (Input, Conv2D, MaxPool2D, Flatten, Dense, MaxPooling2D, BatchNormalization, ReLU, GlobalAveragePooling2D)
...
def build_cnn_model(model_type,input_shape, num_classes, layers, use_bottleneck=False, attention_type=None):
...
#     return build_cnn_model(model_type='resnet', input_shape, num_classes, [2,2,2,2], use_bottleneck=True, attention_type=attention_type)
#
# def resnet34(input_shape=(224,224,3),num_classes=1000, attention_type='CBAM'):
#     return build_cnn_model(model_type='resnet',input_shape,num_classes,[3,4,6,3],use_bottleneck=True, attention_type=attention_type)
...
#     return build_cnn_model(model_type='resnet',input_shape,num_classes,[3,4,23,3],use_bottleneck=True, attention_type=attention_type)
#
# def resnet152(input_shape=(224,224,3),num_classes=1000, attention_type='CBAM'):
#     return build_cnn_model(model_type='resnet',input_shape,num_classes,[3,8,36,3],use_bottleneck=True, attention_type=attention_type)
...
#         if attention == "CBAM":
#             attention_output = CBAM_block(x, filter_num=512, reduction_ratio=16, kernel_size=7, name="Conv_Last_CBAM_")
#
