...
from ..layers.layers import stage, vgg_conv_block, select_attention


def resnet50(num_classes, input_shape=(48, 48, 3), attention_type='CBAM'):
...
def resnet18(num_classes, input_shape=(48, 48, 3), attention_type='CBAM'):
    input = Input(input_shape, name='input')
    layers = [2,2,2,2]
...
def vgg16(num_classes, input_shape=(48,48,1), attention_type='CBAM'):
    activation = 'relu'
    input = Input(input_shape, name='input')
    # Conv1
